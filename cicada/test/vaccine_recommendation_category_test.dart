...
void main() {
  ...
  test(
    'Complex Example #1: HepB risk 3-dose, 60 years, Diabetes only -> SCDM',
    () {
      final r = run(
        antigen: 'HepB',
  ...
  test(
    'Complex Example #2: HepB risk 3-dose, 60 years, Diabetes + HIV -> '
    'High-Risk',
    () {
      final r = run(
        antigen: 'HepB',
  ...
  test(
    'Patient Not Recommended Further Vaccination: only Not Complete has one',
    () {
