  ...
  "series": [
    {
      ...
      "vaccineGroup": "RSV",
      "seriesAdminGuidance": [
        "Except in rare circumstances, a monoclonal antibody is not needed for most infants younger than age 8 months who are born 14 or more days after their mother received Pfizer/Abrysvo RSV vaccine.",
        "The infant should receive a monoclonal antibody younger than 8 months if the pregnant woman received an RSV vaccine, but encountered any one of the following issues. The dose was administered in the incorrect route/site, was of lower than recommended volume, was administered before 24 weeks gestation, was not the Pfizer/Abrysvo product, had preparation errors prior to administration, or had storage issues.",
      ...
      "seriesDose": [
        {
          ...
          "inadvertentVaccine": [
            ...
            {"vaccineType": "RSV, mRNA, injectable, PF", "cvx": "326"}
          ],
          "recurringDose": "No",
    ...
    },
    {
      ...
      "indication": [
        ...
        },
        {
          ...
          "endAge": "20 months",
          "guidance":
              "Children with cystic fibrosis who have either manifestations of severe lung disease (previous hospitalization for pulmonary exacerbation in the first year of life or abnormalities on chest imaging that persist when stable) or weight-for-length less than the 10th percentile"
        },
        {
          "observationCode": {
        ...
        {
          "observationCode": {"text": "Severe immunocompromise", "code": "246"},
              ...
              "set": [
                {
                  "setID": "1",
                  "setDescription":
                      "Target Dose is not needed after the patient turns 8 months old",
                  "condition": [
                    {
                      "conditionID": "1",
                      "conditionType": "Age",
              ...
              "set": [
                {
                  "setID": "1",
                  "setDescription":
                      "Dose is not needed if the patient has received a dose during the current season",
                  "condition": [
                    {
                      "conditionID": "1",
              ...
              "set": [
                {
                  "setID": "1",
                  "setDescription":
                      "Dose is not needed if the patient is under 8 months of age",
                  "condition": [
                    {
                      "conditionID": "1",
                      "conditionType": "Age",
                ...
                },
                {
                  "setID": "2",
                  "setDescription":
                      "Dose is not needed if patient is 8 months or older and received a dose under 8 months this season.",
                  "conditionLogic": "AND",
                  "condition": [
                    {
                      "conditionID": "1",
            ...
            },
            {
              ...
              "set": [
                ...
                },
                {
                  "setID": "4",
                  "setDescription":
                      "Second 100 mg injection is not needed if patient is 8 months or older and the first 100 mg injection was not administered.",
                  "conditionLogic": "AND",
                  "condition": [
                    {
                      "conditionID": "1",
    ...
    },
    {
      ...
      "vaccineGroup": "RSV",
      "seriesAdminGuidance": [
        "Either maternal RSV vaccination with Pfizer/Abrysvo or use of a monoclonal antibody in the infant is recommended to prevent RSV lower respiratory tract infection, but administration of both products is not needed for most infants. At this time, a pregnant woman who receives Abrysvo during one pregnancy is not recommended to receive Abrysvo during a subsequent pregnancy. ACIP will make decisions concerning revaccination as more data become available.",
        "RSVPreF3 (GSK, Arexvy) is licensed for adults 50 years and older. mRNA-1345 (Moderna, Mresvia) is licensed for adults 60 years and older. These vaccines are not licensed for pregnant women.",
        "The infant should receive a monoclonal antibody younger than 8 months if the pregnant woman received an RSV vaccine, but encountered any one of the following issues. The dose was administered in the incorrect route/site, was of lower than recommended volume, was administered before 24 weeks gestation, was not the Pfizer/Abrysvo product, had preparation errors prior to administration, or had storage issues."
      ],
      "seriesType": "Risk",
      ...
      "indication": [
        {
          ...
          "guidance":
              "Pregnant women should receive 1 dose of RSVpreF (Pfizer, Abrysvo) vaccine during 32 through 36 weeks gestation starting 1-2 months prior to the anticipated beginning of the RSV season and ending 1-2 months prior to the anticipated end of the season. RSVpreF vaccine (Abrysvo, Pfizer) is currently approved and recommended for administration as a single dose. Sufficient evidence does not exist at this time to determine the need for additional doses in subsequent pregnancies."
        }
      ],
      "seriesDose": [
        {
              ...
              "set": [
                {
                  "setID": "1",
                  "setDescription":
                      "Dose is not recommended to be repeated if Arexvy or Mresvia were administered.",
                  "condition": [
                    {
                      "conditionID": "1",
                      "conditionType": "Vaccine Count By Age",
    ...
    },
    {
      ...
      "indication": [
        ...
        },
        {
          ...
          "endAge": "75 years",
          "guidance":
              "Includes congestive heart failure and cardiomyopathies, excluding isolated hypertension"
        },
        {
          "observationCode": {"text": "Chronic lung disease", "code": "017"},
          "description": "Administer to persons who have chronic lung disease.",
          ...
          "endAge": "75 years",
          "guidance":
              "Includes chronic obstructive pulmonary disease [COPD], emphysema, asthma, interstitial lung disease, cystic fibrosis"
        },
        {
        ...
        {
          "observationCode": {"text": "End stage renal disease", "code": "114"},
          "description": "Administer to persons with end stage renal disease.",
          "beginAge": "50 years",
          "endAge": "75 years",
          "guidance":
              "Includes dependence on hemodialysis or other renal replacement therapy"
        },
        {
          "observationCode": {
        ...
        {
          "observationCode": {"text": "Emphysema", "code": "215"},
        ...
        },
        {
          ...
          "description":
              "Administer to persons diabetes mellitus complicated by chronic kidney disease",
          "beginAge": "50 years",
          "endAge": "75 years"
        },
        {
          "observationCode": {"text": "Severe obesity", "code": "257"},
        ...
        {
          "observationCode": {"text": "Frailty", "code": "262"},
