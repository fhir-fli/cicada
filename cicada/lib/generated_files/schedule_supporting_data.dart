  ...
  "observations": {
    "observation": [
      ...
      },
      {
        ...
        "codedValues": {
          "codedValue": [
            ...
            {"code": "D73.0", "codeSystem": "ICD10CM", "text": "Hyposplenism"},
            {
              "code": "Q89.01",
              "codeSystem": "ICD10CM",
      ...
      },
      {
        ...
        "codedValues": {
          "codedValue": [
            ...
            {"code": "J45.998", "codeSystem": "ICD10CM", "text": "Other asthma"}
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "codedValues": {
          "codedValue": [
            ...
            {"code": "1191", "codeSystem": "RXNORM", "text": "Aspirin"}
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "codedValues": {
          "codedValue": [
            ...
            {"code": "Z72.0", "codeSystem": "ICD10CM", "text": "Tobacco use"}
          ]
        }
      },
      {
      ...
      },
      {
        ...
        "clarifyingText":
            "e.g., household or regular babysitting\r Applies when adoptee is from a country with high or intermediate endemicity"
      },
      {
        "observationCode": "045",
        "observationTitle":
      ...
      },
      {
        ...
        "clarifyingText":
            "A general definition of health care personnel is given in the National Healthcare Safety Network [NHSN] manual [https://www.cdc.gov/nhsn/pdfs/hps-manual/hps_manual-exp-plus-flu-portfolio.pdf] in the definitions section.",
        "codedValues": {
          "codedValue": [
            {
              "code": "223366009",
      ...
      },
      {
        ...
        "clarifyingText":
            "Includes infantile spasms, uncontrolled epilepsy, or progressive encephalopathy for the administration of any pertussis-containing\r vaccine",
        "codedValues": {
          "codedValue": [
            {
              "code": "84757009",
      ...
      },
      {
        "observationCode": "150",
        "observationTitle":
            "T-lymphocyte [cell-mediated and humoral] - interferon-gamma or interferon-alpha deficiencies",
        "indicationText":
            "Administer to persons who have T-lymphocyte [cell-mediated and humoral] - interferon-gamma or interferon-alpha deficiencies.",
        "contraindicationText":
            "Do not vaccinate if the patient has cell-mediated or humoral T-lymphocyte defects related to interferon-gamma or interferon-alpha deficiencies."
      },
      {
        "observationCode": "151",
        "observationTitle":
      ...
      },
      {
        ...
        "indicationText":
            "Administer to persons who have Moderate persistent or severe persistent asthma.",
        "codedValues": {
          "codedValue": [
            {
              "code": "370219009",
      ...
      },
      {
        ...
        "clarifyingText":
            "Includes heart failure, coronary artery disease, congenital heart disease, excluding isolated hypertension",
        "codedValues": {
          "codedValue": [
            {
              "code": "128292002",
      ...
      },
      {
        ...
        "indicationText":
            "Administer to persons with diabetes mellitus complicated by chronic kidney disease",
        "codedValues": {
          "codedValue": [
            {
              "code": "127013003",
      ...
      },
      {
        ...
        "indicationText":
            "Administer to persons with neurologic or neuromuscular conditions causing impaired airway clearance or respiratory muscle weakness",
        "clarifyingText":
            "Includes poststroke dysphagia, amyotrophic lateral sclerosis, muscular dystrophy; excluding history of stroke without impaired airway clearance",
        "codedValues": {
          "codedValue": [
            {
      ...
      },
      {
        ...
        "indicationText":
            "Administer to persons with diabetes mellitus complicated by neuropathy",
        "codedValues": {
          "codedValue": [
            {
              "code": "230572002",
      ...
      },
      {
        ...
        "indicationText":
            "Administer to persons with diabetes mellitus complicated by retinopathy",
        "codedValues": {
          "codedValue": [
            {
              "code": "4855003",
      ...
      },
      {
        ...
        "indicationText":
            "Administer to persons with diabetes mellitus complicated by end-organ damage",
        "codedValues": {
          "codedValue": [
            {
              "code": "E11.65",
      ...
      },
      {
        ...
        "indicationText":
            "Administer to persons with diabetes requiring treatment with insulin",
        "codedValues": {
          "codedValue": [
            {
              "code": "170747006",
      ...
      },
      {
        "observationCode": "267",
        "observationTitle":
            "Diabetes requiring treatment with sodium-glucose cotransporter-2 (SGLT2) inhibitor",
        "indicationText":
            "Administer to persons with diabetes requiring treatment with sodium-glucose cotransporter-2 (SGLT2) inhibitor",
        "codedValues": {
          "codedValue": [
            {
              "code": "Z94.83",
      ...
      },
      {
        "observationCode": "270",
        "observationTitle":
            "Severe allergic reaction after previous dose of Chikungunya vaccine",
        "contraindicationText":
            "Do not vaccinate if the patient has had a severe allergic reaction after previous dose of Chikungunya vaccine",
        "codedValues": {
          "codedValue": [
            {
              "code": "317",
      ...
      },
      {
        ...
        "indicationText":
            "Administer to persons traveling to a country or territory where there is a chikungunya outbreak"
      },
      {
        "observationCode": "272",
        "observationTitle":
