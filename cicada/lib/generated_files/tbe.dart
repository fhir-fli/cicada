      ...
      'indication': [
        {
          'observationCode': {
            'text':
                'Moving or traveling to an area where TBE is endemic and '
                'will have extensive exposure to ticks because of their '
                'planned outdoor activities and itinerary',
            'code': '249',
          },
          'description':
        ...
        },
        {
          'observationCode': {
            'text':
                'Moving or traveling to an area where TBE is endemic who '
                'might engage in outdoor activities in areas where ticks '
                'are likely to be found',
            'code': '250',
          },
          'description':
              'TBE vaccine may be considered for persons moving or '
              'traveling to an area where TBE is endemic who might engage '
              'in outdoor activities in areas where ticks are likely to be '
              'found',
          'beginAge': '1 year',
          'endAge': '16 years',
          'guidance':
    ...
    },
    {
      ...
      'indication': [
        ...
        },
        {
          'observationCode': {
            'text':
                'Laboratory workers with a potential for exposure to TBE '
                'virus',
            'code': '251',
          },
          'description':
