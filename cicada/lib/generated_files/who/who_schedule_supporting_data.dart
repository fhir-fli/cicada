...
final whoScheduleSupportingData = ScheduleSupportingData.fromJson({
  "liveVirusConflicts": {
    "liveVirusConflict": [
      {
        "previous": {"vaccineType": "OPV, bivalent", "cvx": "178"},
        "current": {"vaccineType": "OPV, bivalent", "cvx": "178"},
      ...
      {
        "previous": {"vaccineType": "OPV, bivalent", "cvx": "178"},
        "current": {"vaccineType": "Measles/Rubella (MR)", "cvx": "04"},
        "conflictBeginInterval": "1 day",
        "minConflictEndInterval": "24 days",
        "conflictEndInterval": "28 days"
      },
      {
        "previous": {"vaccineType": "Measles/Rubella (MR)", "cvx": "04"},
        "current": {"vaccineType": "OPV, bivalent", "cvx": "178"},
        "conflictBeginInterval": "1 day",
        "minConflictEndInterval": "24 days",
        "conflictEndInterval": "28 days"
      ...
      {
        "previous": {"vaccineType": "OPV, bivalent", "cvx": "178"},
        "current": {"vaccineType": "Rotavirus, monovalent (RV1)", "cvx": "116"},
        "conflictBeginInterval": "1 day",
        "minConflictEndInterval": "24 days",
        "conflictEndInterval": "28 days"
      },
  ...
  "vaccineGroups": {
    "vaccineGroup": [
      {"name": "BCG", "administerFullVaccineGroup": "No"},
      {"name": "HepB", "administerFullVaccineGroup": "No"},
      {"name": "DTP", "administerFullVaccineGroup": "Yes"},
      {"name": "Hib", "administerFullVaccineGroup": "No"},
      {"name": "Polio", "administerFullVaccineGroup": "No"},
      {"name": "MR", "administerFullVaccineGroup": "Yes"},
      {"name": "MMR", "administerFullVaccineGroup": "Yes"},
      {"name": "PCV", "administerFullVaccineGroup": "No"},
      {"name": "Rotavirus", "administerFullVaccineGroup": "No"},
      {"name": "HPV", "administerFullVaccineGroup": "No"},
      {"name": "HepA", "administerFullVaccineGroup": "No"},
      {"name": "Yellow Fever", "administerFullVaccineGroup": "No"},
      {"name": "JE", "administerFullVaccineGroup": "No"},
      {"name": "Meningococcal", "administerFullVaccineGroup": "No"},
      {"name": "Typhoid", "administerFullVaccineGroup": "No"},
      {"name": "Cholera", "administerFullVaccineGroup": "No"},
      {"name": "Rabies", "administerFullVaccineGroup": "No"},
      {"name": "Influenza", "administerFullVaccineGroup": "No"},
      {"name": "COVID-19", "administerFullVaccineGroup": "No"}
    ]
  },
  ...
  "observations": {
    "observation": [
      ...
      {
        "observationCode": "1023",
        "observationTitle": "Pregnant",
        "indicationText": "Patient is pregnant"
      },
      {
        "observationCode": "1024",
        "observationTitle": "Chronic medical condition",
        "indicationText":
            "Patient has a chronic medical condition increasing influenza risk"
      },
      {
        "observationCode": "1025",
        "observationTitle": "WHO influenza priority - young child",
        "indicationText":
            "Child aged 6 months to 5 years (WHO influenza priority group)"
      },
      {
        "observationCode": "1026",
        "observationTitle": "WHO influenza priority - older adult",
        "indicationText":
            "Older adult aged 65 years or older (WHO influenza priority group)"
      },
      {
