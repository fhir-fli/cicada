...
final AntigenSupportingData varicella = AntigenSupportingData.fromJson({
  ...
  'series': [
    {
      ...
      'vaccineGroup': 'Varicella',
      'seriesAdminGuidance': [
        'HIV-infected people eligible for vaccination should get 2 '
            'doses of single-antigen varicella vaccine separated by 3 '
            'months. HIV-infected people should not get the combination '
            'MMRV vaccine.',
      ],
      'seriesType': 'Standard',
      'selectSeries': {
    ...
    },
    {
      ...
      'vaccineGroup': 'Varicella',
      'seriesAdminGuidance': [
        'Vaccination should be emphasized for those who have close '
            'contact with persons at high risk for severe disease or are '
            'at high risk for exposure or transmission. Pregnant women '
            'should be assessed for evidence of varicella immunity. Women '
            'who do not have evidence of immunity should receive the first '
            'dose of varicella vaccine upon completion or termination of '
  ...
  'vaccineRecommendationCategory': [
    {
      'worksheetName': 'Childhood 2-dose',
      'seriesName': 'Varicella childhood 2-dose series',
