...
final AntigenSupportingData meningococcalB = AntigenSupportingData.fromJson(
{
    ...
    "series": [
        ...
        {
            "seriesName": "Meningococcal B 2-dose series MenB-FHbp Shared Clinical Decision Making",
            "targetDisease": "Meningococcal B",
            "vaccineGroup": "Meningococcal B",
            "seriesAdminGuidance": [
                "Delay MenB until after pregnancy due to lack of safety data in pregnant persons. May administer if at increased risk and vaccination benefits outweigh potential risks.",
        ...
        {
            "seriesName": "Meningococcal B 3-dose series MenB-4C Shared Clinical Decision Making",
            "targetDisease": "Meningococcal B",
            "vaccineGroup": "Meningococcal B",
            "seriesAdminGuidance": [
                "Delay MenB until after pregnancy due to lack of safety data in pregnant persons. May administer if at increased risk and vaccination benefits outweigh potential risks.",
        ...
        {
            "seriesName": "Meningococcal B 3-dose series MenB-FHbp Shared Clinical Decision Making",
            "targetDisease": "Meningococcal B",
            "vaccineGroup": "Meningococcal B",
            "seriesAdminGuidance": [
                "Delay MenB until after pregnancy due to lack of safety data in pregnant persons. May administer if at increased risk and vaccination benefits outweigh potential risks.",
                    ...
                    "conditionalSkip": [
                        {
                            ...
                            "set": [
                                {
                                    "setID": "1",
                                    "setDescription": "Dose is not required if the patient received a valid 2-dose series under previous licensure",
                                    "condition": [
                                        {
                                            "conditionID": "1",
