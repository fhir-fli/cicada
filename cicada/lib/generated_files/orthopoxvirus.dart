...
final AntigenSupportingData orthopoxvirus = AntigenSupportingData.fromJson({
    ...
    "vaccine": {
      "contraindication": [
        ...
        },
        {
          ...
          "contraindicationGuidance":
              "Major cardiac risk factors include hypertension, diabetes, hypercholesterolemia, heart disease at age 50 years or younger in a first-degree relative, and smoking.",
          "contraindicatedVaccine": [
            {"vaccineType": "vaccinia smallpox", "cvx": "75"}
          ]
        }
  ...
  "series": [
              ...
              "set": [
                {
                  "setID": "1",
                  "setDescription":
                      "Target Dose is not needed if patient received a single dose primary series",
                  "condition": [
                    {
                      "conditionID": "1",
    ...
    },
    {
      ...
      "indication": [
        {
          "observationCode": {"text": "Known exposure to mpox", "code": "241"},
          "description":
