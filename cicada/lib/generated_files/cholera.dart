  ...
  'series': [
    {
      ...
      'vaccineGroup': 'Cholera',
      'seriesAdminGuidance': [
        'The Vaxchora package insert states that CVD 103-HgR should '
            'not be given to patients who have received oral or parenteral '
            'antibiotics in the preceding 14 days, because antibiotics '
            'might have activity against the vaccine strain.',
        'Non-U.S. vaccines (WC-rBS and BivWC) would count as valid '
            'only if there is documentation that a complete series with '
            'the appropriate dosing has been given.',
        'No data exist on use of the currently available lyophilized '
            'CVD 103-HgR formulation in immunocompromised populations.',
      ],
      'seriesType': 'Risk',
      'selectSeries': {
        'defaultSeries': 'No',
