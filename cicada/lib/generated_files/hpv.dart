...
final AntigenSupportingData hpv = AntigenSupportingData.fromJson({
    ...
    'vaccineGroup': {
      'contraindication': [
        ...
        },
        {
          ...
          'contraindicationText':
              'Do not vaccinate with 9vHPV if the patient has a '
  ...
  'series': [
    {
      ...
      'vaccineGroup': 'HPV',
      'seriesAdminGuidance': [
        'ACIP recommends routine HPV vaccination at age 11 or 12 '
            'years. Vaccination can be given starting at age 9 years.',
        'Shared clinical decision-making (SCDM) is recommended '
            'regarding Human papillomavirus (HPV) vaccination for persons '
            '27-45 years of age. Shared clinical decision-making '
            'recommendations are intended to be flexible and should be '
              ...
              'set': [
                {
                  ...
                  'setDescription':
                      ...
                      'administered at least 5 months - 4 das from the '
                      'previous dose OR two total doses have already been '
                      'administered',
                  'conditionLogic': 'OR',
                  'condition': [
                    {
              ...
              'set': [
                {
                  'setID': '2',
                  'setDescription':
                      'Dose is not required once 5 months has passed since '
                      'dose 1 or two total doses have already been '
                      'administered.',
                  'conditionLogic': 'OR',
                  'condition': [
                    {
    ...
    },
    {
      ...
      'vaccineGroup': 'HPV',
      'seriesAdminGuidance': [
        "At the provider's discretion, the recommendation for a 3-dose "
            'schedule does not apply to children aged less than 15 years '
            'with asplenia, asthma, chronic granulomatous disease, chronic '
            'liver disease, chronic lung disease, chronic renal disease, '
            'CNS anatomic barrier defines (e.g., cochlear implant), '
            'complement deficiency, diabetes, heart disease, or sickle '
            'cell disease.',
        'Shared clinical decision-making (SCDM) is recommended '
            'regarding Human papillomavirus (HPV) vaccination for persons '
            '27-45 years of age. Shared clinical decision-making '
      ...
      'indication': [
        ...
        },
        {
          ...
          'description':
              ...
              'and humoral] - interferon-gamma/Interleukin 12 axis '
              'deficiencies.',
          'beginAge': '9 years',
        },
        {
          'observationCode': {
            'text':
                'T-lymphocyte [cell-mediated and humoral] - '
                'interferon-gamma or interferon-alpha deficiencies',
            'code': '150',
          },
          'description':
              'Administer to persons who have T-lymphocyte [cell-mediated '
  ...
  'vaccineRecommendationCategory': [
    ...
    },
    {
      'worksheetName': '2-dose',
      'seriesName': 'HPV 2-dose series',
      'patientBeginAge': '27 years',
      'patientEndAge': '46 years',
      'forecastTargetDose': 'Any',
      'includedIndication': 'n/a',
      'excludedIndication': 'n/a',
      'category': 'SCDM',
    ...
    {
      'worksheetName': '3-dose start under 15',
      'seriesName': 'HPV 3-dose start under 15 years series',
      'patientBeginAge': '0 days',
      'patientEndAge': '27 years',
      'forecastTargetDose': 'Any',
    ...
    {
      'worksheetName': 'Male 3-dose start under 15',
      'seriesName': 'HPV male 3-dose start under 15 years series',
      'patientBeginAge': '0 days',
      'patientEndAge': '27 years',
      'forecastTargetDose': 'Any',
    ...
    {
      'worksheetName': 'Risk male 2-dose',
      'seriesName': 'HPV risk male 2-dose series',
      'patientBeginAge': '0 days',
      'patientEndAge': '11 years',
      'forecastTargetDose': 'Any',
    ...
    {
      'worksheetName': 'Risk male 3-dose',
      'seriesName': 'HPV risk male 3-dose series',
      'patientBeginAge': '9 years',
      'patientEndAge': '27 years',
      'forecastTargetDose': 'Any',
