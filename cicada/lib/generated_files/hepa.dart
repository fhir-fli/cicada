    ...
    },
    {
      ...
      'indication': [
        ...
        },
        {
          ...
          'beginAge': '19 years',
          'guidance':
              'includes, but is not limited to persons with hepatitis B '
              'virus (HBV) infection, hepatitis C virus (HCV) infection, '
              'cirrhosis, fatty liver disease, alcoholic liver disease, '
              'autoimmune hepatitis, or an alanine aminotransferase (ALT) '
              'or aspartate aminotransferase (AST) level persistently '
        ...
        },
        {
          ...
          'beginAge': '19 years',
          'guidance':
              'includes persons who use injections or non-injection drugs '
              '(i.e., all who use illegal drugs)',
        },
        {
          'observationCode': {
            'text':
                'Anticipate close personal contact with international '
                'adoptee',
            'code': '044',
          },
          'description':
          ...
          'beginAge': '19 years',
          'guidance':
              'close personal contact includes but is not limited to '
              'household contact, caretaker, or regular babysitter. The '
              'first dose of the HepA vaccine series\r should be '
              'administered as soon as adoption is planned, ideally 2 or '
        ...
        },
        {
          ...
          'beginAge': '19 years',
          'guidance':
              'Includes persons who work with HAV-infected nonhuman '
              'primates or with clinical or nonclinical material '
              'containing HAV in a research laboratory setting should be '
              'vaccinated. No other occupational groups (e.g., health care '
              'providers or food handlers) have been demonstrated to be at '
              'increased risk for HAV infection because of occupational '
              'exposure',
        },
        {
          'observationCode': {
        ...
        },
        {
          ...
          'beginAge': '19 years',
          'guidance':
              'A homeless person is defined as 1) a person who lacks '
              'housing (regardless of whether the person is a member of a '
              'family), including a person whose primary residence during '
              'the night is a supervised public or private facility (e.g., '
              'shelter) that provides temporary living accommodations and '
              'a person who is a resident in transitional housing, 2) a '
              'person without permanent housing who might live on the '
              'streets; or stay in a shelter, mission, single-room '
              'occupancy facility, abandoned building, vehicle, or any '
              'other unstable or nonpermanent situation, or 3) who is '
              'doubled up, a term that refers to a situation where persons '
              'are unable to maintain their housing situation and are '
              'forced to stay with a series of friends or extended family '
              'members. In addition, previously homeless persons who are '
              'to be released from a prison or a hospital might be '
              'considered homeless if they do not have a stable housing '
              'situation to which they can return.',
        },
        {
          'observationCode': {
            'text':
        ...
        },
        {
          'observationCode': {
            'text':
                'Persons in settings that provide services to adults with '
                'high proportion of those persons have risk factors for '
                'HAV infection',
            'code': '185',
          },
          'description':
          ...
          'beginAge': '19 years',
          'guidance':
              'Settings in which a high proportion of persons have risk '
              'factors for HAV infection include health care settings that '
              'focus on persons who use injection or noninjection drugs, '
              'as well as group homes and nonresidential day care '
      ...
      'indication': [
        ...
        },
        {
          ...
          'guidance':
              'close personal contact includes but is not limited to '
              'household contact, caretaker, or regular babysitter. The '
              'first dose of the HepA vaccine series should be '
              'administered as soon as adoption is planned, ideally 2 or '
              'more weeks before the arrival of the adoptee',
        },
        {
    ...
    },
    {
      ...
      'indication': [
        ...
        },
        {
          ...
          'beginAge': '19 years',
          'guidance':
              'close personal contact includes but is not limited to \r '
              'household contact, caretaker, or regular babysitter. The '
              'first dose of the HepA vaccine series\r should be '
              'administered as soon as adoption is planned, ideally 2 or '
              'more weeks before the arrival of the adoptee',
