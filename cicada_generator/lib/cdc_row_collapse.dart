// Copy of `cicada/test/cdc_row_collapse.dart`, which is canonical. Edit that
// file and copy the change here; `cdc_row_collapse_sync_test.dart` in cicada
// fails if the two drift apart. See that file for why they are not shared.
